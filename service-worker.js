const CACHE='pharm360-platform-v8-branding';
const CORE=['./','./index.html','./1_BOSING_PHARM360_DMED.html','./offline.html','./manifest.webmanifest','./assets/pharm360-logo.png','./assets/icon-192.png','./assets/icon-512.png','./assets/marjon-intro.mp3'];
